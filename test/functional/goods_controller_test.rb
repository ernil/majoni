...
class GoodsControllerTest < ActionController::TestCase
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post :create, good: { color: @good.color, price: @good.price, size: @good.size, stock_price: @good.stock_price, title: @good.title }
    end
  ...
  test "should update good" do
    put :update, id: @good, good: { color: @good.color, price: @good.price, size: @good.size, stock_price: @good.stock_price, title: @good.title }
    assert_redirected_to good_path(assigns(:good))
  end
